...
before(async function() {
  ...
  if (mongoose.connection.readyState === 0) {
    await mongoose.connect('mongodb+srv://roeinagar011:tjiBqVnrYAc8n0jY@pawpal-network.zo5jd6n.mongodb.net/?retryWrites=true&w=majority&appName=pawpal-network', { 
  ...
  server = app.listen(0, () => { 
    console.log('Test server runnings');
  });
});
